...
<body>
    ...
    <section class="add-products">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <textarea name="details" class="box" required placeholder="Nhập Chi Tiết Sản Phẩm" cols="30"
                rows="10"></textarea>
            ...
            <div class="box">
                ...
                <div class="flex-btn">
                    ...
                    <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn"
                        onclick="return confirm('delete this product?');">Xóa Bỏ</a>
                </div>
            </div>
            <?php
      }
   }else{
      echo '<p class="empty">Sản Phẩm Đã Được Thêm Vào!</p>';
   }
   ?>
