...
<body>
   ...
   ?>
            <div class="box">
                <p> Tên Người dùng : <span><?= $fetch_message['user_id']; ?></span> </p>
                ...
                <a href="admin_contacts.php?delete=<?= $fetch_message['id']; ?>"
                    onclick="return confirm('delete this message?');" class="delete-btn">Xóa</a>
            </div>
            <?php
         }
      }else{
         echo '<p class="empty">Bạn Không Có Thông Báo Nào!</p>';
      }
   ?>
