...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         if($update_image){
            ...
            $message[] = 'Hình Ảnh Được Cập Nhập Thành Công!';
         };
      };
   };
   ...
   if(!empty($update_pass) AND !empty($new_pass) AND !empty($confirm_pass)){
      if($update_pass != $old_pass){
         ...
         $message[] = 'Đã Cập Nhập Thành Công Mật Khẩu!';
      }
   }
            ...
            <div class="flex">
                <div class="inputBox">
                    ...
                    <input type="text" name="name" value="<?= $fetch_profile['name']; ?>"
                        placeholder="Cập nhật tên người dùng" required class="box">
                    <span>Email :</span>
                ...
                <div class="inputBox">
                    ...
                    <input type="password" name="update_pass" placeholder="Nhập mật khẩu trước đó" class="box">
